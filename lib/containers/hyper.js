...
(function(Mousetrap) {
    ...
    Mousetrap.prototype.bindGlobal = function(keys, callback, action) {
        ...
        console.log('registering global keys', keys),
...
class Hyper extends Component {
  ...
  attachKeyListeners() {
    ...
    Mousetrap.bindGlobal('mod+1', moveTo.bind(this, 0));
    Mousetrap.bindGlobal('mod+2', moveTo.bind(this, 1));
    Mousetrap.bindGlobal('mod+shift+left', (e) => {
      console.log('left', e);

    });
    /*
    const keys = new Mousetrap(this.refs.hyper);
    keys.bindGlobal('mod+1', moveTo.bind(this, 0));
    keys.bindGlobal('mod+2', moveTo.bind(this, 1));
    ...
    keys.bind('mod+9', moveTo.bind(this, -1));

    keys.bindGlobal('mod+shift+left', (e) => {
      console.log('left', e);
