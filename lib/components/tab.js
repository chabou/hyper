...
export default class Tab extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    console.log(
      this.props.lastActivity,
      nextProps.lastActivity,
      this.state.flashing
    );
    if (
      this.props.lastActivity !== nextProps.lastActivty &&
      !this.state.flashing
    ) {
  ...
  template(css) {
    ...
    return (
      ...
      >
        ...
        <i
          className={css("icon", hovered && "iconHovered")}
  ...
  styles() {
    return {
      ...
      flashing: {
        textShadow: "0 0 1.8em #50E3C2, 0 0 1.8em #50E3C2, 0 0 1.8em #50E3C2"
      },
